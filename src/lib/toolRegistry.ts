...
export class ToolRegistry {
   ...
   */
  static async initializeDefaultToolsForProject(projectId: string): Promise<void> {
   ...
   */
  static async initializeDefaultSubAgentsForProject(projectId: string): Promise<void> {
    const supabase = getSupabaseClient();
   ...
   */
  static async getActiveSubAgents(projectId: string): Promise<SubAgent[]> {
    const supabase = getSupabaseClient();
   ...
   */
  static async getActiveMCPTools(projectId: string): Promise<MCPTool[]> {
    const supabase = getSupabaseClient();
   ...
   */
  static buildToolingInstructions(
    subAgents: SubAgent[],
    mcpTools: MCPTool[]
  ): string {
    let instructions = '';
 ...
 */
export async function initializeProjectTooling(projectId: string): Promise<void> {
